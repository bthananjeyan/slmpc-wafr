...
def pointbot_config(exp_cfg):
	...
	exp_cfg.ss_approx_mode = "convex_hull" # Should change to 'convex_hull'
	exp_cfg.value_approx_mode = "linear" # could be linear too, but I am pretty sure knn is better
